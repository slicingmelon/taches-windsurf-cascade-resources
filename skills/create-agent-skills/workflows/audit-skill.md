...
```bash
# Read main file
cat ~/.codeium/windsurf/skills/{skill-name}/SKILL.md

# Check for workflows and references
ls ~/.codeium/windsurf/skills/{skill-name}/
ls ~/.codeium/windsurf/skills/{skill-name}/workflows/ 2>/dev/null
ls ~/.codeium/windsurf/skills/{skill-name}/references/ 2>/dev/null
```
