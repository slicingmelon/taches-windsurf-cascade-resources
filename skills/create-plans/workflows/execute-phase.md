...
**Critical: Cascade automates everything with CLI/API before checkpoints.** Checkpoints are for verification and decisions, not manual work.
...
```
I automated: [what Cascade already did via CLI/API]
