...
<context>
Skill detection: list files matching `.windsurf/skills/*/SKILL.md` to identify available skills.
</context>
...
Focus on the specific issue provided by the user if given, otherwise analyze broader context.
