...
IF the user's message provides clear context:
→ Skip to context_analysis
</no_context_handler>

<context_analysis>
Analyze the user's message (or conversation context) to extract what's already provided:
...
<process>
1. Check if context was provided in the user's message
