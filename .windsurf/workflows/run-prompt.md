...
<context>
Get git status and list recent prompts in `./prompts/` to determine the next available prompt number.
</context>
...
<input>
The user will specify which prompt(s) to run in their message, which can be:
