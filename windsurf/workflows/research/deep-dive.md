...
<objective>
Conduct a deep-dive investigation into the topic provided by the user (or the current discussion if no topic was specified).
...
Skip questions where the user's message already provides the answer.
</initial_questions>
...
- Implementation context is specific enough for Cascade to apply
