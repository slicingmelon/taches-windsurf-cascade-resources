...
ROADMAP.md        ← Structure (phases)
    ↓
phases/XX/PLAN.md ← Implementation (Cascade-executable)
    ↓
...
**Audience**: Both human and Cascade
...
**Purpose**: Define Cascade-executable tasks
**Audience**: Cascade (the implementer)
...
**Audience**: Cascade (via create-meta-prompts)
...
<cross_phase_context>
When planning Phase N, Cascade should understand:
