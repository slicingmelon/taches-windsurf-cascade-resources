...
7. Read domain SKILL.md: `~/.codeium/windsurf/skills/expertise/[domain]/SKILL.md`
...
**Key insight:** PLAN.md IS the prompt that Cascade executes. Not a document that
...
- Cascade automated work needing visual/functional verification? → checkpoint:human-verify
...
<execution_context>
@~/.codeium/windsurf/skills/create-plans/workflows/execute-phase.md
@~/.codeium/windsurf/skills/create-plans/templates/summary.md
[If plan has ANY checkpoint tasks (type="checkpoint:*"), add:]
@~/.codeium/windsurf/skills/create-plans/references/checkpoints.md
</execution_context>
...
Tasks are instructions for Cascade, not Jira tickets.
</anti_patterns>
...
- [ ] Tasks are specific enough for Cascade to execute
