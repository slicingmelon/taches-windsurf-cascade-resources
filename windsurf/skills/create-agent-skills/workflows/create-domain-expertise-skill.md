...
Explain:
```
Domain expertise skills go in: ~/.codeium/windsurf/skills/expertise/{domain-name}/
...
Location: ~/.codeium/windsurf/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ~/.codeium/windsurf/skills/expertise/{domain-name}
mkdir -p ~/.codeium/windsurf/skills/expertise/{domain-name}/workflows
mkdir -p ~/.codeium/windsurf/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/.codeium/windsurf/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `~/.codeium/windsurf/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/.codeium/windsurf/skills/expertise/{domain-name}/
