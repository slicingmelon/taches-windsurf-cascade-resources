...
<description>
SKILL.md serves as an overview. Reference files contain details. Cascade loads reference files only when needed.
</description>
...
<description>
Validation scripts are force multipliers. They catch errors that Cascade might miss and provide actionable feedback.
</description>
